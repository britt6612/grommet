...
module.exports = {
  ...
  async viteFinal(config) {
    ...
    return mergeConfig(config, {
      ...
      plugins: [
        // Pre-transform plugin: ensures all story/source files are converted to
        // plain ES module JS before inject-export-order-plugin (enforce:'post')
        // runs es-module-lexer on them. Without this, .tsx and .js files that
        // contain JSX reach the lexer as raw source and cause parse errors.
        {
